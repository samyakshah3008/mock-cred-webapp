...
const SpecialMessage = () => {
  return (
    <div className="flex flex-col m-auto gap-10 p-4 w-full lg:w-[90%] mt-10 border-2 border-solid bg-orange-50 rounded-md ">
      ...
      <div className="flex flex-col lg:flex-row gap-4 lg:gap-0">
        ...
        <div className="flex-1 flex flex-col gap-2 justify-center items-center">
          ...
          <div className="text-center w-[90%]">
            ...
            absolutely well. I hope you will love to use MockCred and it
